...
export const products: ProductItem[] = [
  {
    ...
    description: 'Unified dashboard for teams, analytics, and workflow automation.',
    tag: 'Platform',
  },
  {
    id: 'p2',
    title: 'Commerce Suite',
    description: 'Headless e-commerce with real-time inventory and payment integrations.',
    tag: 'E-Commerce',
  },
  {
    id: 'p3',
    title: 'Analytics Hub',
    description: 'Business intelligence with custom reports and data visualization.',
    tag: 'Analytics',
  },
  {
    id: 'p4',
    title: 'Mobile Workforce',
    description: 'Field service app with offline sync and GPS tracking capabilities.',
    tag: 'Mobile',
  },
  {
    id: 'p5',
